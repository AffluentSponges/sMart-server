...
.then(() => {
  ...
  return knex.schema.createTable('products', products => {
          ...
          products.dateTime('preferred_time_and_date')
          products.dateTime('sale_time_and_date')
          products.dateTime('est_pickup_time_and_date')
          products.dateTime('actual_pickup_time_and_date')
          products.dateTime('est_deliver_time_and_date')
          products.dateTime('actual_delivery_time_and_date')
          products.timestamps()
        })
})
.then(() => {
